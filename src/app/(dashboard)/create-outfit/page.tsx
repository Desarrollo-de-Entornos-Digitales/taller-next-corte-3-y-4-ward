...
export default function CreateOutfitPage() {
    ...
    const handleSaveOutfit = async () => {
        ...
        try {
            ...
            setSaveError(err.message || 'Error al guardar el outfit');
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-12">
                    ...
                    <p className="text-white/60 text-lg">
                        Selecciona las prendas de tu armario, ponle nombre y elige la ocasión. Tu outfit quedará guardado y listo para usarlo
                        cuando lo necesites.
                    </p>
                </div>
