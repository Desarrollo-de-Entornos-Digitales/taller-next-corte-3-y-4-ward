...
export default function RegisterPage() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-md mx-4 rounded-[36px] overflow-hidden bg-white/25 backdrop-blur-4xl border border-white/20 border-t-[2px] border-b-[2px] border-white/30 shadow-[0_30px_80px_rgba(15,23,42,0.22)] px-8 py-10 flex flex-col items-center gap-6">
